  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4.mb-lg-5
      ...
      .col-lg-8
        .p-4.bg-secundario-s5.rounded-4.mb-3
          p.mb-0 #[em Within the configuration of their facilities, hotels have different areas, with furniture and appropriate amenities according to their use. See some examples.]
    ...
    .row.justify-content-center.align-items-center.mb-4.mb-lg-5.z-2
      .col-lg-7.mb-4.mb-lg-0
        .p-4.bg-acento-botones-a5.rounded-4.mb-3
          p.mb-0 #[em The most important differentiation of a hotel structure is established by the areas for public use or intended for guests, and the areas for private use and in which services are prepared. Here is a list of some of them.]
        p.mb-0 La diferenciación más importante de una estructura hotelera se establece mediante las áreas de uso público, o destinadas a los huéspedes, y las áreas de uso privado, en las que se preparan los servicios. Esta es una lista de algunas de ellas:
      .col-sm-10.col-lg-5
        figure
    ...
    .mt-5.pt-4
      ...
      img(data-aos="fade-up")(src="@/assets/curso/tema3/3.png", alt="").z-2 
      .row.justify-content-center.z-2.mb-3
        .col-lg-10.p-4.drop-shadow(data-aos="fade-down")
          div.banner-text.shadow
            p.mb-0 #[em Public areas are spaces designed for guests and visitors to interact, relax, and access hotel services. These areas are usually comfortable, accessible, and equipped to provide a pleasant experience during the stay. Below are some examples of the most common public areas in a hotel.]
    ...
    p.mb-4.mb-lg-5 Los hoteles ofrecen diferentes servicios para brindar comodidad, atención y una experiencia agradable a los huéspedes durante su estadía. Estos servicios pueden variar según el tipo y la categoría del hotel. A continuación, se presentan algunos de los servicios hoteleros más comunes.
